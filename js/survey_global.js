...
if (active && surveyAcceptsCookies() && surveyNewSession() && !surveyExceptionUrl(surveyHref, exceptionUrl)) {
  ...
  var Sites = [
    ...
    "www.cte.ikeadt.com/de/de", "de", "de,tr,ru", "D", -1, "TS", "ms", "de_DE", "de", "de",
    "www.ppe.ikeadt.com/de/de", "de", "de,tr,ru", "D", -1, "TS", "ms", "de_DE", "de", "de",
    ...
    "www.cte.ikeadt.com/se/sv", "se", "se,fi,en", "D", -1, "TS", "ms", "sv_SE", "se", "sv",
  ...
  // 15/04/2013 - serbia
  inviteLine1["sr"] = "Pomozite nam da budemo jo&#353; bolji!";
  inviteLine2["sr"] = "Da li &#382;elite da u&#269;estvujete u na&#353;oj anketi? Za ispunjavanje ankete bi&#263;e potrebno oko 10 minuta.";
  inviteLine3["sr"] = "Ukoliko pristanete da u&#269;estvujete, anketa &#263;e se pokrenuti kad zavr&#353;ite posetu sajtu IKEA.com. ";
  inviteYes["sr"] = "&#381;elim da u&#269;estvujem";
  inviteNo["sr"] = "Ne, hvala";
  ...
  if (inviteCountry == "GFK") {
    survey_cookie += Math.random().toString()
  }
